...
const Login = () => {
  const [loginEmail, setLoginEmail] = useState("your username");//if you want you can set it for autofill
  const [loginPass, setLoginPass] = useState("password");///if you want you can set it for autofill
